...
void UpdateStage7()
{
	...
	// Center scroll
	sf = ( ( stageframe % 16 ) << 2 );
	devkit_UNSAFE_SMS_VRAMmemcpy64( 0, stage7animtilese_bin + sf );
	devkit_UNSAFE_SMS_VRAMmemcpy64( 64, stage7animtilese_bin + sf + 128 );
	...
	if( disablescroll == 0 )
	{
		...
		devkit_UNSAFE_SMS_VRAMmemcpy64( 256, stage7animtilesd_bin + sf );
		devkit_UNSAFE_SMS_VRAMmemcpy64( 320, stage7animtilesd_bin + sf + 128 );


		// Far scroll
		sf = ( ( ( stageframe >> 3 ) % 16 ) << 2 );
		devkit_UNSAFE_SMS_VRAMmemcpy64( 128, stage7animtiles_bin + sf );
		devkit_UNSAFE_SMS_VRAMmemcpy64( 192, stage7animtiles_bin + sf + 128 );
	}

	// Water falls
	devkit_UNSAFE_SMS_VRAMmemcpy32( 384, stage7animtilesc_bin + ( ( ( stageframe >> 1 ) % 8 ) << 5 ) );
