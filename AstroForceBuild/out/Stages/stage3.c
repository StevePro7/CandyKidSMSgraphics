...
void UpdateStage3()
{
	...
	// Soltamos las tiles
	devkit_UNSAFE_SMS_VRAMmemcpy64( 32, spaceanimtiles_bin + sf );
	devkit_UNSAFE_SMS_VRAMmemcpy64( 32 + 64, spaceanimtiles_bin + sf + 64 );
	devkit_UNSAFE_SMS_VRAMmemcpy64( 32 + 128, spaceanimtiles_bin + sf + 128 );
	devkit_UNSAFE_SMS_VRAMmemcpy32( 32 + 192, spaceanimtiles_bin + sf + 192 );
