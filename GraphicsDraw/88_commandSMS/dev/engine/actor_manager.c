...
void engine_actor_manager_exec_move()
{
	...
	engine_font_manager_draw_data( co->delta, 17, 14 );
	engine_font_manager_draw_data( co->timer, 27, 14 );
...
void engine_actor_manager_undo_move()
{
	...
	engine_font_manager_draw_data( co->delta, 17, 18 );
	engine_font_manager_draw_data( co->timer, 27, 18 );
	//printf( "UNDO move\n" );
}