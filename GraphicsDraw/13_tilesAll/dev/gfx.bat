...
bmp2tile.exe raw\game_title.bmp -savetiles "game_title (tiles).psgcompr" -noremovedupes -planar -tileoffset 152 -savetilemap "game_title (tilemap).bin" -savepalette "game_title (palette).bin" -fullpalette -exit
