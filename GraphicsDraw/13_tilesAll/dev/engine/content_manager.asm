...
;--------------------------------------------------------
	.area _CODE
;content_manager.c:8: void engine_content_manager_load_tiles()
;	---------------------------------
; Function engine_content_manager_load_tiles
; ---------------------------------
_engine_content_manager_load_tiles::
;content_manager.c:11: devkit_SMS_loadPSGaidencompressedTiles( font_tiles__tiles__psgcompr, FONT_TILES );
	ld	hl, #0x0000
	push	hl
	...
	pop	af
;content_manager.c:15: devkit_SMS_loadPSGaidencompressedTiles( apex_tiles__tiles__psgcompr, APEX_TILES );
	ld	hl, #0x0040
	ex	(sp),hl
	...
	pop	af
	pop	af
;content_manager.c:16: devkit_SMS_loadBGPalette( ( void * ) apex_tiles__palette__bin );
	ld	bc, #_apex_tiles__palette__bin+0
	push	bc
	call	_devkit_SMS_loadBGPalette
	pop	af
	ret
;content_manager.c:19: void engine_content_manager_load_sprites()
;	---------------------------------
; Function engine_content_manager_load_sprites
; ---------------------------------
_engine_content_manager_load_sprites::
;content_manager.c:30: }
	ret
	.area _CODE
	.area _INITIALIZER
	.area _CABS (ABS)
