...
bmp2tile.exe raw\adriana.bmp -savetiles "adriana (tiles).psgcompr" -noremovedupes -nomirror -planar -tileoffset 0 -savepalette "adriana (palette).bin" -fullpalette  -spritepalette
