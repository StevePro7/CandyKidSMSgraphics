...
;content_manager.c:27: devkit_SMS_loadPSGaidencompressedTiles( adriana__tiles__psgcompr, SPRITE_TILES + 64 );
	...
	call	_devkit_SMS_loadPSGaidencompressedTiles
	pop	af
;content_manager.c:30: devkit_SMS_loadPSGaidencompressedTiles( skullnc__tiles__psgcompr, SPRITE_TILES + 80 );
	ld	hl, #0x0150
	ex	(sp),hl
	ld	hl, #_skullnc__tiles__psgcompr
	push	hl
	call	_devkit_SMS_loadPSGaidencompressedTiles
	pop	af
	pop	af
;content_manager.c:31: devkit_SMS_loadSpritePalette( ( void * ) skullnc__palette__bin );
	ld	bc, #_skullnc__palette__bin+0
	push	bc
