...
{
	// Sprite tiles.
	devkit_SMS_loadPSGaidencompressedTiles( candymama__tiles__psgcompr, SPRITE_TILES );
	devkit_SMS_loadPSGaidencompressedTiles( candykids__tiles__psgcompr, SPRITE_TILES + 192 );
